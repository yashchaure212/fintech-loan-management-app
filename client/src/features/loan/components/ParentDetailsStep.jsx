...
function ParentDetailsStep({ loanApplicationId, onBack, onNext }) {
  ...
  if (isFetching) {
    return (
      <LoanWizardShell step={3} title="Parent & Co-Applicant Details" description="Loading...">
        ...
        <section className="space-y-6">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="text-helper">You can add Father, Mother, or both.</p>
            </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <FormField label="Relation" error={errors.parents?.[index]?.relation?.message}>
                      <select
