...
function Navbar() {
  ...
  const NotificationPanel = ({ mobile = false }) => (
    <div
      className={[
        "overflow-hidden rounded-2xl border border-border bg-background shadow-[0_20px_60px_rgba(15,23,42,0.18)]",
            ...
            >
                        ...
                        {loanCatalog.map((loan) => {
                          ...
                          return (
                            <button
                              ...
                              className={[
                                "flex w-full items-center gap-2 rounded-lg px-3 py-2.5 text-left text-xs font-semibold transition",
                                active
              ...
              <div className="relative">
                ...
                {desktopMenu === "resources" && (
                  <div className="absolute right-0 top-[calc(100%+8px)] w-80 rounded-2xl border border-border bg-background p-2 shadow-[0_24px_70px_rgba(15,23,42,0.16)]">
        ...
        >
          ...
          >
            <SheetTitle className="flex items-center gap-3 text-white">
              <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-white/15 font-bold ring-1 ring-white/20">
                L
              </span>
                    ...
                    {(isAdmin
                      ...
                      return (
                        <Link
                          ...
                          onClick={closeMobile}
                          className={[
                            "flex min-h-13 items-center gap-3 rounded-xl px-3 text-sm font-semibold transition",
                            active
                              ? "bg-primary-soft text-primary"
                              : "hover:bg-muted",
                          ].join(" ")}
