...
const tones = {
  blue: {
    bg: "bg-[#eef3f7]",
    icon: "bg-[#12304a] text-white",
    border: "hover:border-[#9aabb8]",
  },
  violet: {
    bg: "bg-[#f1f4f6]",
    icon: "bg-[#1d405a] text-white",
    border: "hover:border-[#9aabb8]",
  },
  orange: {
    bg: "bg-[#f4f5f5]",
    icon: "bg-[#23475e] text-white",
    border: "hover:border-[#9aabb8]",
  },
  green: {
    bg: "bg-[#eef4f1]",
    icon: "bg-[#205642] text-white",
    border: "hover:border-[#9aabb8]",
  },
  cyan: {
    bg: "bg-[#edf5f7]",
    icon: "bg-[#19566a] text-white",
    border: "hover:border-[#9aabb8]",
  },
  rose: {
    bg: "bg-[#f5f1f2]",
    icon: "bg-[#6d3948] text-white",
    border: "hover:border-[#9aabb8]",
  },
};
            ...
            return (
              ...
              >
                <div
                  ...
                  `}
                >
                  <div className="absolute -right-7 -top-7 h-20 w-20 rounded-full border border-black/5" />
